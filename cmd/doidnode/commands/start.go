...
func init() {
	...
	StartCmd.Flags().Bool(flags.Admin_RPC, false, "Enable admin RPC over http")
	StartCmd.Flags().String(flags.Admin_RPCAddr, "127.0.0.1:8555", "Admin RPC over HTTP listen address")
	...
	StartCmd.Flags().StringSlice(flags.P2P_Addr, []string{"/ip4/0.0.0.0/tcp/26667"}, "Libp2p listen address")
